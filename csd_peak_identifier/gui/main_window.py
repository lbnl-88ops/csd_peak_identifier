...
class CsdPeakIdentifierApp(QMainWindow):
    def __init__(self, csd_path):
        ...
        self.isotope_group.setStyleSheet(
        ...
        self.toolbar.setStyleSheet(
            f"background: {COLOR_BG}; border: none; font-family: {FONT_MONO};"
        )
        ...
        self.eval_list.setStyleSheet(
            f"background: {COLOR_PLOT_BG}; font-family: {FONT_MONO}; color: {COLOR_TEXT};"
        )
        sidebar.addWidget(QLabel("Identified isotopes"))
        ...
        for txt, func, style in [
            (
                ...
                f"background: {COLOR_ACTION}; color: white; font-weight: bold;",
            ),
    ...
    def update_view(self, candidate=None, rebuild=False):
        ...
        if rebuild or self.eval_list.count() != (
    ...
    def update_peak_list(self):
        ...
        current_mq = (
            self.peak_list.currentItem().data(Qt.UserRole)
            if self.peak_list.currentItem()
            else None
        )
    ...
    def start_identification(self):
        ...
        self.candidate_header.setText("Candidate isotopes (sorted by score)")
    ...
    def exit_identification(self):
        ...
        self.candidate_header.setText("Candidate isotopes")
