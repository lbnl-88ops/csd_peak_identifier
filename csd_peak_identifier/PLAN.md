...
- [x] Phase 5: Modular GUI Refactoring
  - [x] Create `csd_peak_identifier/gui` package.
  - [x] Separate `main.py` into `constants.py`, `canvas.py`, `dialogs.py`, and `main_window.py`.
  - [x] Create root-level `app.py` as an external entry point.
  - [x] Maintain `main.py` as an internal entry point.
